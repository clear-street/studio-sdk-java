...
class AccountPnlSummaryRetrieveParamsTest {

    @Test
    fun createAccountPnlSummaryRetrieveParams() {
        AccountPnlSummaryRetrieveParams.builder().accountId("x").build()
    }

    @Test
    fun getPathParam() {
        val params = AccountPnlSummaryRetrieveParams.builder().accountId("x").build()
